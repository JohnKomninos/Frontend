...
const ShowBeach = (props) =>{
  return(
    <div className="child-div">
      ...
      <img onClick={(event)=>{props.show(props.beach)}} src={props.beach.image}/><br/>
      ...
      <form onSubmit={(event)=>{props.handleUpdate(props.beach,   event)}}>
          ...
          Image:<input type ="text" onChange={props.handleUpdateImage}/><br/>
          Location:<input type ="text" onChange={props.handleUpdateLocation}/><br/>
