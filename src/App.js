...
// Created newBeach component for adding beaches to the data base
  return (
    <>
      {displayShow !== true ?
      <NewBeach handleName={handleName} handleImage={handleImage} handleLocation={handleLocation} handlePopularity={handlePopularity} submitBeach={submitBeach} toggleForm={toggleForm} showForm={showForm}/> : <ShowPage show={show} showData={showData} showCommentData={showCommentData} handleAddImage={handleAddImage} addImage={addImage} index={index} photoForward={photoForward} photoBackwards={photoBackwards} deletePhoto={deletePhoto} handleAddComment={handleAddComment} addReview={addReview} deleteComment={deleteComment}/>}
      {displayShow !== true ?
